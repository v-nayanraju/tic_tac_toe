...
public class tictactoe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn1.setForeground(new java.awt.Color(153, 0, 52));
        btn1.setToolTipText("Click to set ur response");
        ...
        btn2.setForeground(new java.awt.Color(153, 0, 52));
        btn2.setToolTipText("Click to set ur response");
        ...
        btn3.setForeground(new java.awt.Color(153, 0, 52));
        btn3.setToolTipText("Click to set ur response");
        ...
        btn4.setForeground(new java.awt.Color(153, 0, 52));
        btn4.setToolTipText("Click to set ur response");
        ...
        btn5.setForeground(new java.awt.Color(153, 0, 52));
        btn5.setToolTipText("Click to set ur response");
        ...
        btn6.setForeground(new java.awt.Color(153, 0, 52));
        btn6.setToolTipText("Click to set ur response");
        ...
        btn7.setForeground(new java.awt.Color(153, 0, 52));
        btn7.setToolTipText("Click to set ur response");
        ...
        btn8.setForeground(new java.awt.Color(153, 0, 52));
        btn8.setToolTipText("Click to set ur response");
        ...
        btn9.setForeground(new java.awt.Color(153, 0, 52));
        btn9.setToolTipText("Click to set ur response");
        ...
        txtfield.setBackground(new java.awt.Color(11, 253, 153));
        ...
        getContentPane().add(txtfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 312, 61));
        ...
        getContentPane().add(txtfield1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 100, 144, 63));
        ...
        getContentPane().add(txtfield2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 180, 144, 63));
        ...
        getContentPane().add(Button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 260, 144, 65));
        ...
        getContentPane().add(Button2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 350, 144, 65));

        jPanel2.setBackground(new java.awt.Color(255, 255, 0));
        jPanel2.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jLabel1.setBackground(new java.awt.Color(255, 255, 0));
        jLabel1.setFont(new java.awt.Font("Adobe Garamond Pro Bold", 2, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 0, 0));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tictactoegame/icon.png"))); // NOI18N
        jLabel1.setText("Tic-Tac-Toe");
        jLabel1.setToolTipText("The Title");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 470, 70));
